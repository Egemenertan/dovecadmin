...
export default function BlogListPage() {
  ...
  useEffect(() => {
    console.log('🚀 BlogListPage: useEffect starting...');
    let unsubscribe: (() => void) | null = null;

    const startListening = () => {
      try {
        console.log('🔥 BlogListPage: Starting Firebase listener...');
        setError(null);
        
        // Real-time listener başlat
        unsubscribe = subscribeToBlogs((blogsData) => {
          console.log('📊 BlogListPage: Received blogs data:', blogsData);
          console.log('📈 BlogListPage: Number of blogs:', blogsData.length);
          setBlogs(blogsData);
        });
        
        console.log('✅ BlogListPage: Firebase listener started successfully');
      } catch (err) {
        console.error('❌ BlogListPage: Error starting listener:', err);
    ...
    // Cleanup function
    return () => {
      console.log('🧹 BlogListPage: Cleaning up Firebase listener...');
      if (unsubscribe) {
        unsubscribe();
      }
    };
          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                {/* Kullanıcı bilgisi */}
                <div className="hidden md:flex items-center space-x-3 bg-slate-50 rounded-lg px-3 py-2">
